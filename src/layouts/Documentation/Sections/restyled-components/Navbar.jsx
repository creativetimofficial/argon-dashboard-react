    ...
    return (
      <>
        ...
        <div className="ct-example">
          <Nav className="nav-tabs-code" id="navbar-tab" role="tablist">
            <NavItem>
              <NavLink
                aria-controls="navbar-component"
                aria-selected={true}
                className="active"
                data-toggle="tab"
                href="#pablo"
                id="navbar-component-tab"
          ...
          <TabContent>
            <TabPane
              aria-labelledby="navbar-component-tab"
            ...
            <TabPane
              aria-labelledby="navbar-html-tab"
              className="fade"
              id="navbar-html"
              role="tabpanel"
            />
